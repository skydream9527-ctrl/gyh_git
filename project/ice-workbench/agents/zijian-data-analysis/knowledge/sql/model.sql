select
    ...
    case 
        when date < 20260306 and (expose_cnt>0 or consum_cnt_v2_no_push>0) then 1
        when date >= 20260306 and is_valid_user_new_no_push='是' then 1 
        else 0
    end as is_feed_active_new_no_push,
    is_vliad_user_new,
