...
export interface TokenPair {
  access_token: string;
  /** Absent when ICE_REFRESH_COOKIE_ENABLED — delivered via httpOnly cookie instead. */
  refresh_token?: string;
  /** Present when cookie mode is active (frontend skips localStorage for refresh). */
