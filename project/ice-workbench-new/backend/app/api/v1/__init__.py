...
api_router.include_router(invitations.task_router, prefix="/tasks", tags=["invitations"])
api_router.include_router(invitations.me_router, prefix="/me", tags=["invitations"])
...
api_router.include_router(client_errors.router, tags=["client-errors"])
