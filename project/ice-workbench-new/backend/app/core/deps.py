...
from app.services.auth.auth_svc import ensure_user_for_email, load_user_by_id
...
from .ws_auth import extract_bearer
...
async def get_current_user_ws(
    ...
    # extract_bearer enforces the negotiation contract: the subprotocol token
    # takes precedence over the query param (see core/ws_auth).
    _chosen_proto, bearer = extract_bearer(
