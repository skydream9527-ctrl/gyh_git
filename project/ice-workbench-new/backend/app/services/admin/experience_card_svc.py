...
def merged_system_prompt(
    ...
    *,
    ...
    """
    from app.services.agent.agent_prompt_builder import build_base_prompt
...
def _build_skill_catalog_section(
    *,
    ...
    """
    from app.services.integration.skill_svc import list_all
    ...
    from app.services.llm.tool_runner import _read_skill_description_for_task
