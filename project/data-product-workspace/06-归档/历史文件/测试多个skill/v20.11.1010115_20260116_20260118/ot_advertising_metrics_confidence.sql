...
SELECT 
    ...
    sum(ad_expose) as total_value,
    avg(ad_expose) as mean_value,
    stddev(ad_expose) as std_value
FROM q2
...
SELECT 
    ...
    'mean' as metric_type,
    count(distinct did) as sample_size,
    sum(ad_require) as total_value,
    avg(ad_require) as mean_value,
    stddev(ad_require) as std_value
FROM q2
GROUP BY date, user_type, app_ver
...
SELECT 
    ...
    'mean' as metric_type,
    count(distinct did) as sample_size,
    sum(ad_click) as total_value,
    avg(ad_click) as mean_value,
    stddev(ad_click) as std_value
FROM q2
GROUP BY date, user_type, app_ver
