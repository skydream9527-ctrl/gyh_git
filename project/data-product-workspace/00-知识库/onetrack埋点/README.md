...
onetrack埋点/
├── README.md                     ← 本文件(总入口)
├── _原始文档/                    ← 源 Excel 存档(含 MD5 校验、复现说明)
├── _scripts/                     ← 解析 + 文档生成脚本(可复现)
├── 内容中心业务/
│   ├── README.md                 ← 业务总览 + 模块导航
...
> 📦 原始 Excel 已存档至 [_原始文档/](_原始文档/README.md)(含 MD5 校验、内容规模统计与复现命令)。
...
| 回溯原始 Excel | [_原始文档/README.md](_原始文档/README.md) |
