---- 0523 支付宝已安装且30天内活跃≤16天的用户 ∩ B1可售卖人群

随机输出2w用户人群包


--口径：支付宝已安装且30天内活跃≤16天的用户 ∩ B1可售卖人群（需剔除已售卖人群）
...
,
    s2 as (
        ...
        where
            date between 20250423 and 20250522
            and is_top=0
        group by
            did
        having
...
,
    ...
    s10 as (
        ...
        ( 
            ...
            FROM
                hive_zjyprc_hadoop.dwm.dwm_app_usage_did_di
...
INSERT OVERWRITE table  iceberg_zjyprc_hadoop.tmp.newhome_zhifubao_thirdapp_open_2025_0522_test_all_01
...
join s9 on s8.did=s9.did
    ...
    join s10 on t2.distinct_id=s10.did
