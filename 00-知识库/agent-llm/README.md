...
├── rag/                          ← 检索增强
│   ├── OVERVIEW.md                    ← 开篇导读：知识库"长什么样"（一张表）+ 部署三档 + 设计决策链
│   ├── retrieval-basics.md
...
│   ├── 子Agent派单协作规范.md          ← ICE Workbench 派单规则：何时派/怎么派/并行派单/反模式
...
│   ├── pm-workspace/PM-AI协作工作区设计.md ← ICE Workbench 产品级Agent工作台设计
│   ├── cases/data-monitor/数据监控Agent设计.md ← 定时任务类Agent设计案例：身份/SOP/配置
│   ├── cases/gray-release/灰度发布Agent设计与SOP.md ← 版本灰度分析Agent六阶段SOP+知识库驱动设计
│   └── design-patterns.md
...
│   ├── LLM应用开发实践指南.md          ← 从0到1生产级LLM应用完整路线图（Level0-4+Checklist+反模式）
...
- 本仓库已有：
  - **[智能体设计模式全文归档（424 页 / 21 章 + 7 附录）](../文档归档/Markdown文件/2026-05-25-智能体设计模式-Agentic-Design-Patterns.md)** — Antonio Gulli《Agentic Design Patterns》中文版，涵盖提示词链/路由/并行化/反思/工具调用/规划/多Agent/记忆/MCP/RAG/A2A/安全护栏/评估监控等全谱系，源自 github.com/xindoo/agentic-design-patterns
  - **[从 demo 到生产工具 — 数据产品 AI 实践经验分享](../文档归档/Markdown文件/2026-04-08-从demo到生产工具-数据产品AI实践经验分享.md)** — 生产级=95%工程+5%Prompt；三阶段演进（提示词工程→Agent+Skill分层→Harness Engineering）；Skill vs Agent vs 多Agent 选型；分步拆解/多Skill+Agent 编排 Case
  - **[0327 AI 实践阶段性分享](../文档归档/Markdown文件/2026-03-29-AI实践阶段性分享.md)** — AI 编程工具选型（Antigravity/CodeX/Trae/Micode/OpenCode/Claude Code/Qwen Code）、模型排序、Skill 开发 AI Native 流程、安卓应用开发、Openclaw 用途
  - [ICE 项目内 references/agentic-design-patterns.md](../../01-业务项目/ICE-Data-Workbench-v3/references/agentic-design-patterns.md) — 早期精简版设计模式笔记
