...
| 归档时间 | 文档名称 | 类型 | 飞书链接/本地路径 | 备注 |
|---------|---------|------|------------------|------|
| 2026-07-21 | 2026Q3工作事项优先级与人天评估 | Markdown+飞书 | [飞书文档](https://feishu.cn/wiki/YQRVwRktciHTXgk2Qe9cwc9YnCd) / [本地Markdown](./工作区指南/2026-07-21-Q3工作事项优先级与人天评估.md) | 6项核心事项人天评估、可替代/降级方案、排期节奏、待决策事项 |
| 2026-07-08 | 2026年Q3 OKR规划（双KA聚焦V3） | Markdown+飞书 | [飞书文档](https://feishu.cn/wiki/TsObwFTS8iVqTtkPxEVcvgjLnHg) / [本地Markdown](./工作区指南/2026-Q3-OKR-V3.md) | Q3 OKR最终版，聚焦AI平台能力建设+AI数据赋能培训双KA |
...
| 2026-07-14 | 数据夜校第三期：数据分析方法 | Markdown | [飞书文档](https://mi.feishu.cn/docx/RrypdJN81oDhLDxLV6Jc0qF6n2b) / [本地Markdown](./会议纪要/2026-07-14-数据夜校第三期-数据分析方法.md) | 数据分析四个思考角度（维度/参照/视角/起始点）、七种常用分析方法、SQL谓词下推优化、留存计算要点，检查学员作业 |
| 2026-07-14 | ICE-DATA-WORK 2.0方案评审会议纪要 | Markdown | [本地Markdown](./会议纪要/2026-07-14-ICE-DATA-WORK-2.0方案评审会议纪要.md) | ICE工作台2.0方案评审，确认Mify网关、NL-SQL重构、Hook机制等核心功能规划 |
...
|---------|---------|------|----------|------|
| 2026-07-15 | 2026-07-14 每日工作回顾 | Markdown | [本地Markdown](./每日回顾/2026-07-14-每日工作回顾.md) | 上滑人群需求交付、数据夜校SQL课程完成、ICE2.0方案讨论、开屏实验扩量、里包恩AI测试流程跑通 |
| 2026-07-14 | 2026-07-13 每日工作回顾 | Markdown | [本地Markdown](./每日回顾/2026-07-13-每日工作回顾.md) | 信息流重写埋点方案共识、多Agent框架落地、数据需求排期确认、今日8项待办 |
...
| 归档时间 | 文档名称 | 类型 | 飞书链接/本地路径 | 备注 |
|---------|---------|------|------------------|------|
| 2026-07-20 | 息壤数据接入数鲸平台需求PRD-下载管理器收入 | Markdown+飞书 | [飞书文档](https://feishu.cn/wiki/ByTqwbe2CiLEdjkFufxcLYwWn5c) / [本地Markdown](./需求文档/2026-07-17-息壤数据接入数鲸平台需求PRD.md) | 解决老BI数据口径GAP问题，将息壤下载管理器收入数据（日期、分成后总收入）接入数鲸平台模型，供预算侧统计分析使用 |
| 2026-07-20 | 信息流 LTV 预估与验证方案 V3.0 | Markdown+飞书 | [飞书文档](https://feishu.cn/wiki/Pd9MwvoP5ilg7tkwsrjcvBoOnjc) / [本地Markdown](./产品方案/2026-07-20-信息流LTV预估与验证方案-V3.0.md) | 基于 7 月 16 日会议纪要、专业评审与 V2.0 二次优化；将所有 P0/P1/P2 待确认问题前置，财务主目标改为未来 N 天贡献毛利直预测，并严格拆分 RMST、活跃天数、V 与因果增量 |
| 2026-07-21 | 信息流 LTV 预估公式讨论 V4.1 | Markdown+飞书 | [飞书文档](https://feishu.cn/wiki/YRamwJJMPi6S7Hk01ZFcmJb2naf) / [本地Markdown](./产品方案/2026-07-21-信息流LTV预估公式讨论-V4.1.md) | 聚焦 LT×V 公式与 V 降幅；采用飞书兼容排版，推荐第一版使用分阶段 LT × 分阶段 V，并列出 8 个待拍板问题 |
...
| 归档时间 | 文档名称 | 类型 | 飞书链接/本地路径 | 备注 |
|---------|---------|------|------------------|------|
| 2026-07-13 | nl-mapping-table-sql-v2 口径维护清单 | Markdown+TSV+飞书表格 | [飞书表格](https://mi.feishu.cn/wiki/HexVwtWZHitynpk05VictOtQnXj) / [本地Markdown](./数据资产/2026-07-13-nl-mapping-table-sql-v2-口径维护清单.md) / [TSV](./数据资产/2026-07-13-nl-mapping-table-sql-v2-口径维护清单.tsv) | 盘点已维护与待维护口径，服务 nl-sql 数据资产补齐 |
