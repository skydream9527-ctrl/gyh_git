...
### CM-DIM-001: 多维指标聚合表 — 启动方式枚举值

**Table**: dm_newhome_multi_dimension_indicators_di
...
### CM-DIM-010: 多维留存指标表 — 应用端口枚举值

**Table**: dm_newhome_multi_dimension_retain_indicators_di
**Field**: app_port
